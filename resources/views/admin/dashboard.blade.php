        ...
        <div class="row gutters-sm col-md-12">
            ...
            <div class="col mb-3">
                ...
                <div class="card-body">
                    ...
                    <a href="#" title="View More" data-toggle="tooltip" ><h6 class="card-title text-light">Customer Balance</h6></a></span>
        ...
        <div class="col mb-3">
            <div class="card card-style-1" style="background-color: #005580;color:white;">
                <div class="card-body">
                    ...
                    <span data-toggle="modal" data-target="#lastMonthBusiness">
                    <a href="#" data-toggle="tooltip" title="View More"><h6 class="card-title text-light">Last Month Business</h6></a></span>
            ...
            <div class="card card-style-1" style="background-color: #3399ff;color:white;">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center font-number mb-1">
                        ...
                        <span data-toggle="modal" data-target="#thisMonthBusiness">
                        <a href="#" data-toggle="tooltip" title="View More"><h6 class="card-title text-light">This Month Business</h6></a></span>
                        <span><i class="material-icons">₹</i></span>
                        </div>
                        <div class="sparkline-data" data-value=""></div>
                    </div>
    ...
    <div class="card card-style-1">
      <div class="card-body table-responsive">
        ...
        <table class="table">
        	...
        	<tbody>
            @if($top_associates->count())
        		@foreach($top_associates as $topassociate)
              @if($topassociate->associate != null)
                <tr>
                  <td>{{$topassociate->associate?$topassociate->associate->name:''}}
                  ...
                  <?php /* $topassociate->topAssociate($topassociate->associate_id) */ ?>
                  @if($topassociate->top_invest > 0)
                    <td>
                      <a href="{{route('admin.associatecus',['id'=>$topassociate->associate->id,'q'=>'top_ass'])}}" class="text-success" data-toggle="tooltip" title="View Details">₹ {{$topassociate->top_invest}}
                      </a>
                    </td>
                  @else
                    <td class="text-danger">₹ {{$topassociate->top_invest}}</td>
                  @endif
            ...
            <tbody>
              @foreach($top_invest as $invest)
                <tr>
                  ...
                  @if($invest->topInvesters() > 0)
                    <td>
                      <a href="{{route('admin.transactions',['customer'=>$invest->customers->code])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-success">
                        ₹ {{$invest->topInvesters()}}
                      </a>
                    </td>
                  @else
                    <td>
                      <a href="{{route('admin.transactions',['customer'=>$invest->customers->code])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-danger">
                      ₹ {{$invest->topInvesters()}}
                      </a>
                    </td>
                  @endif
                  <td>
                    {{Carbon\Carbon::parse($invest->customer_first_deposit_date()->deposit_date)->format('m')}}
                  </td>
                  <td>
                    {{Carbon\Carbon::parse($invest->customer_first_deposit_date()->deposit_date)->format('Y')}}
                  </td>
                </tr>
              @endforeach
            </tbody>
...
@endif
 @if(Auth::user()->login_type == 'associate')
    <div class="row col-md-12">
        <div class="col mb-3">
            <div class="card card-style-1" style="background-color: #ff9966;color:white;">
                <div class="card-body">
                    <h2>{{$total_associate_customer}}</h2>
                    <div class="d-flex align-items-center font-number mb-1">
                        <h6 class="card-title text-light">Total Customer </h6>
                        <span><i class="material-icons">person</i></span>
                    </div>
                </div>
            </div>
        ...
        <div class="col mb-3">
            <div class="card card-style-1" style="background-color: #ff6666c2;color:white;">
                <div class="card-body">
                    <h2>{{$self_associate_customer}}</h2>
                    <div class="d-flex align-items-center font-number mb-1">
                        <a href="{{route('associate.my_customer')}}" data-toggle="tooltip" title="View Customers"><h6 class="card-title text-light">Self Customer </h6></a>
                        <span><i class="material-icons">person</i></span>
                    </div>
                </div>
            </div>
        ...
        <div class="col mb-3">
            <div class="card card-style-1" style="background-color: rgb(159, 94, 245);color:white;">
                <div class="card-body">
                    <h6 class="card-title">Last Month Business</h6>
                    <div class="d-flex align-items-center font-number mb-1">
                        <i class="material-icons mr-2">₹</i>
                        <h3 class="mb-0 mr-2">{{ getTotalBusiLastMonth()?getTotalBusiLastMonth():0}}</h3>
                    </div>
                    <a href="{{ route('associate.totCustBusiLastMon') }}" class="text-white pull-right" title="Total Customer Business" data-toggle="tooltip"><i class="material-icons">visibility</i></a>

                    <a href="{{ route('associate.selfCustBusiLastMon') }}" class="text-white pull-right" title="Self Customer Business" data-toggle="tooltip"><i class="material-icons">visibility</i></a>
                    <?php /*
                        <div class="" data-value="" style="background-color: rgb(146, 163, 240);color:white;text-align: center">
                            <a href="{{ route('customer.perCustLadgerBalance',['from_date'=>date("Y-m-01",strtotime("-1 month")),'to_date'=>date("Y-m-t",strtotime("-1 month"))]) }}" class="text-white">View More</a>
                        </div>
                    */ ?>
                </div>
            </div>
        ...
        <div class="col mb-3">
            <div class="card card-style-1" style="background-color: rgb(40, 51, 100);color:white;">
            <div class="card-body">
                <h6 class="card-title">This Month Business</h6>
                <div class="d-flex align-items-center font-number mb-1">
                    <i class="material-icons mr-2">₹</i>
                    <h3 class="mb-0 mr-2">{{ getTotalBusiThisMonth()?getTotalBusiThisMonth():0}}</h3>
                </div>
                <a href="{{ route('associate.totCustBusiThisMon') }}" class="text-white pull-right" title="Total Customer Business" data-toggle="tooltip"><i class="material-icons">visibility</i></a>

                <a href="{{ route('associate.selfCustBusiThisMon') }}" class="text-white pull-right" title="Self Customer Business" data-toggle="tooltip"><i class="material-icons">visibility</i></a>

                 <?php /*<div class="" data-value="" style="background-color: rgb(62, 69, 100);color:white;text-align: center">
                    <a href="{{ route('customer.perCustLadgerBalance',['from_date'=>date("Y-m-01"),'to_date'=>date("Y-m-t")]) }}" class="text-white">View More</a>
                </div>*/ ?>
            </div>
            </div>
        </div>
    <?php /*<div class="col mb-4">
        <div class="card card-style-1" style="background-color: #3399ff;color:white;">
        <div class="card-body">
 ...
 @if(Auth::user()->login_type == 'customer')
    <div class="row col-md-12">
        ...
        <?php /*
            <div class="col mb-3">
                <div class="card card-style-1" style="background-color: rgba(128, 0, 128, 0.986);color:white;">
                <div class="card-body">
        ...
        */ ?>
        ...
        <div class="col mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center font-number mb-1">
                <i class="material-icons mr-2">₹</i>
                <h3 class="mb-0 mr-2">{{Auth::user()->lastMonthCustomerBalance()}}</h3>
                </div>
                <div class="" data-value="" style="background-color: rgb(146, 163, 240);color:white;text-align: center">
                    <a href="{{ route('customer.perCustLadgerBalance',['from_date'=>date("Y-m-01",strtotime("-1 month")),'to_date'=>date("Y-m-t",strtotime("-1 month"))]) }}" class="text-white">View More</a>
                </div>
        ...
        <div class="col mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center font-number mb-1">
                <i class="material-icons mr-2">₹</i>
                <h3 class="mb-0 mr-2">{{Auth::user()->thisMonthCustomerBalance()}}</h3>
                </div>
                <div class="" data-value="" style="background-color: rgb(62, 69, 100);color:white;text-align: center">
                    <a href="{{ route('customer.perCustLadgerBalance',['from_date'=>date("Y-m-01"),'to_date'=>date("Y-m-t")]) }}" class="text-white">View More</a>
                </div>
            </div>
            </div>
