...
@section('content')
  ...
  <div class="d-flex">
    ...
    @if(empcan('export_associate_txn_hist') || Auth::user()->login_type == 'associate')
        <div class="col-md-3" style="margin-left:85%">
            <a href="{{route('associate.export_associate_txn_hist')}}" id="" class="btn btn-danger btn-sm"><i class="material-icons">import_export</i> Excel Export</a>
        </div>
    @endif
