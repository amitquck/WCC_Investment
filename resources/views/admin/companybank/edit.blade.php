        ...
        <div class="modal-body" id="editBank-container">
          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <input type="text" name="amount" class="form-control" value="{{$bank->amount}}" style="width:100%;" placeholder="Enter Amount">
          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <input type="text" name="deposit_date" class="form-control datepicker" style="width:100%;" placeholder="Enter Deposit Date" value="{{ $bank->deposit_date?date('j-m-Y',strtotime($bank->deposit_date)):'' }}">
