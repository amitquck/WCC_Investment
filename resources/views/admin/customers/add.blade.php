...
</div><button class="btn btn-sm btn-outline-primary add_more_bnkdel  pull-right" id="add-more" style="margin-right: 17px;">Add More</button><br><br>
...
</div><button class="btn btn-sm btn-outline-primary add_more pull-right" id="add-more" style="margin-right: 17px;">Add More</button><br><br>
