         ...
         <div class="row">
            ...
            <div class="col-sm-4">
               ...
               <div class="input-group date" data-provide="datepicker">
                  <input disabled type="text" class="form-control" placeholder="Enter Date Of Birth" name="dob" value="<?php echo (isset($customer->customerdetails->dob) && $customer->customerdetails->dob != NUll)?date('d-m-Y',strtotime($customer->customerdetails->dob)):'' ?>">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="form-group col-md-6"><br>
                    ...
                    <input disabled type="text" class="form-control" name="account_holder_name" id="account_holder_name" placeholder="Enter Account Holder Name" value="{{ $b_detail->account_holder_name }} ">
                ...
                <div class="form-group col-md-6"><br>
                    ...
                    <input disabled type="text" class="form-control" name="bank_name" id="bank_name" placeholder="Enter Bank Name" value="{{ $b_detail->bank_name }} ">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input disabled type="text" class="form-control" name="account_number" id="account_number" placeholder="Enter Account Number" value="{{ $b_detail->account_number }} ">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input disabled type="text" class="form-control" name="ifsc_code" id="ifsc_code" placeholder="Enter IFSC Code" value="{{ $b_detail->ifsc_code }} ">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input disabled type="text" class="form-control" name="pan_no" id="pan_no" placeholder="Enter Account Number" value="{{ $b_detail->pan_no }} ">
      ...
      <div class="col-md-12"><br>
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control datepicker" name="cheque_issue_date[{{$key}}]" id="cheque_issue_date" placeholder="Enter Account Holder Name" value="@if($s_cheque->cheque_issue_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_issue_date)) ?> @endif" disabled="">
          </div>
          <div class="form-group col-md-6">
            <label>Cheque Maturity Date</label>
            <input type="text" name="cheque_maturity_date[{{$key}}]" class="form-control datepicker" placeholder="Enter Bank Name" value="@if($s_cheque->cheque_maturity_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_maturity_date)) ?> @endif" disabled="">
      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control datepicker" name="cheque_date[{{$key}}]" id="cheque_date" placeholder="Enter date" value="@if($s_cheque->cheque_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_date)) ?> @endif" disabled>
  ...
  <div class="col-md-12"><br>
  	<div class="row">
  		...
  		<div class="form-group col-sm-4">
  			...
  			Date Of Birth </label>
  			<div class="input-group date" data-provide="datepicker">
  			<input disabled type="text" class="form-control"   id="nominee_dob" placeholder="Enter Date Of Birth" name="nominee_dob"value="<?php echo (isset($customer->customerdetails->dob) && $customer->customerdetails->dob != NUll)?date('d-m-Y',strtotime($customer->customerdetails->dob)):'' ?>">
  			<div class="input-group-addon">
  			<span class="glyphicon glyphicon-th"></span>
  		</div>
...
<input disabled type="file" name="nominee_image" id="nominee_image" placeholder="Enter Image">
