...
<nav aria-label="breadcrumb" class="main-breadcrumb">
   <ol class="breadcrumb breadcrumb-style2">
      ...
      <li class="breadcrumb-item active" aria-current="page">Edit # <span class="text-danger"> {{ ucwords($customer->name) }}</span> </li>
   </ol>
</nav>
<!-- /Breadcrumb -->
@include('flash')
  ...
  <form action="{{route('admin.customerUpdate')}}" method="post" enctype="multipart/form-data">
      {{ csrf_field()}}
        ...
        <div class="col-md-12">
           <div class="row">
              <div class="form-group col-md-4">
                 ...
                 <img src="{{asset('images/customer/'.$customer->customerdetails->image)}}" width="100px" height="100px">

             <!--  <div class="zoom-box">
                 <img src="{{asset('images/customer/'.$customer->customerdetails->image)}}"  alt="Curious Bino" class="img-thumbnail zoomify" style="transform: scale(1) translate(0px, 0px);"/>
               </div> -->
              ...
              <div class="col-sm-4">
                 ...
                 <div class="input-group date" data-provide="datepicker">
                    <input type="text" class="form-control datepicker" placeholder="Enter Date Of Birth" name="dob" autocomplete="off" onchange="ageCalculation(this.value)" value="<?php echo (isset($customer->customerdetails->dob) && $customer->customerdetails->dob != NUll)?date('d-m-Y',strtotime($customer->customerdetails->dob)):'' ?>">
        ...
        <div class="col-md-12">
           <div class="row">
              <div class="form-group col-md-4">
                 <label for="father_husband_wife">Father Name </label>
              ...
              <div class="form-group col-md-4">
                 ...
                 <input type="text" class="form-control" name="age" id="cust_age" placeholder="Enter age" value="{{ $customer->customerdetails->age }}" >
                 @if($errors->has('age'))
        ...
        <div class="form-group col-md-4">
            ...
            <option value="accumulate" @if($customer->customerdetails->payment_type == 'accumulate') selected="selected" @endif>Cumilate</option>
        ...
        <div class="card card-style">
            ...
            <div class="ad-bank-del">
                @foreach($customer->customerBankDetail as $key => $b_detail)
                    <div class="col-md-12">
                        <div class="row">
                            <div class="form-group col-md-6"><br>
                                <input type="hidden" name="bank_customer_id[]" value="{{$customer->id}}" class="form-control">
                                <input type="hidden" name="bank_table_ids[]" value="{{$b_detail->id}}" class="form-control">
                                <label>Account Holder Name</label>
                                <input type="text" class="form-control" name="account_holder_name[{{$key}}]" id="account_holder_name" placeholder="Enter Account Holder Name" value="@if($b_detail){{ $b_detail->account_holder_name }}@endif">
                            ...
                            <div class="form-group col-md-6"><br>
                                ...
                                <input type="text" class="form-control" name="bank_name[{{$key}}]" id="bank_name" placeholder="Enter Bank Name" value="@if($b_detail){{ $b_detail->bank_name }} @endif">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="account_number[{{$key}}]" id="account_number" placeholder="Enter Account Number" value="@if($b_detail){{ $b_detail->account_number }} @endif">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="ifsc_code[{{$key}}]" id="ifsc_code" placeholder="Enter IFSC Code" value="@if($b_detail){{ $b_detail->ifsc_code }} @endif">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="pan_no[{{$key}}]" id="pan_no" placeholder="Enter Account Number" value="@if($b_detail){{ $b_detail->pan_no }} @endif">
            ...
            <button class="col-md-1 btn btn-sm btn-outline-primary add_more_bnkdel" id="add-more" style="margin-left: 983px;">Add More</button><br><br>
        </div>
      ...
      <div class="card card-style">
            ...
            <div class="col-md-12"><br>
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control datepicker" name="cheque_issue_date[{{$key}}]" id="cheque_issue_date" placeholder="Enter Cheque Issue Date" value="@if($s_cheque->cheque_issue_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_issue_date)) ?> @endif" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                  <label>Cheque Maturity Date</label>
                  <input type="text" name="cheque_maturity_date[{{$key}}]" class="form-control datepicker" placeholder="Enter Cheque Maturity Date" value="@if($s_cheque->cheque_maturity_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_maturity_date)) ?> @endif" autocomplete="off">
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="cheque_bank_name[{{$key}}]" id="cheque_bank_name" placeholder="Enter Cheque Bank Name" value="@if($s_cheque){{ $s_cheque->cheque_bank_name }}@endif">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control datepicker" name="cheque_date[{{$key}}]" id="cheque_date" placeholder="Enter Cheque Date" value="@if($s_cheque->cheque_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_date)) ?> @endif" autocomplete="off">
        ...
        <button class="col-md-1 btn btn-sm btn-outline-primary add_more" id="add-more" style="margin-left: 983px;">Add More</button><br><br>
      </div>
      <div class="card card-style">
        ...
        <div class="col-md-12"><br>
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              Date Of Birth </label>
              <div class="input-group date" data-provide="datepicker">
              <input type="text" class="form-control datepicker"   id="nominee_dob" placeholder="Enter Date Of Birth" name="nominee_dob"value="{{$customer->customerdetails->nominee_dob?date('d-m-Y',strtotime($customer->customerdetails->nominee_dob)):''}}" autocomplete="off" onchange="nominee_ageCalculation(this.value)">
              <div class="input-group-addon">
              <span class="glyphicon glyphicon-th"></span>
              </div>
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control zipcode n-get-csc" name="nominee_zipcode" id="nominee_zipcode" placeholder="Enter zipcode" value="{{ $customer->customerdetails->nominee_zipcode }}">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
             ...
             <div class="form-group col-md-4">
                 ...
                 @endif
                 <br>
                 <img src="{{asset('images/customer/'.$customer->customerdetails->nominee_image)}}" width="100px" height="100px">
          </div>
        </div>
      </div>
<!-- <div class="card card-style">
  <div style="background-color:#2b579a; color: white;">&nbsp;Add Customer Commission</div>
    ...
    <div class="form-group col-md-4" style="margin-top:30px;">
      <button type="submit" class="btn btn-primary" id="update-button">Save</button><br>
      <?php /*<button @if($reward == null) type="submit" class="btn btn-primary" @else type="button" class="btn btn-primary disabled" @endif>Save</button><br>*/ ?>
    </div>
  </form>
</div>
<!---------------------------------------------------------------------------->
...
$(document).ready(function(){
  var pType  = '<?php echo $customer->customerdetails->payment_type ?>';
  var reward = '<?php echo $reward ?>';
  var record = '<?php echo $record ?>';
  $(".payment_type").on('change', function(){

    if(pType != $(".payment_type").val() && ($(".payment_type").val() == 'no_interest' || pType == 'no_interest')){
      if($(".payment_type").val() == 'no_interest'){
        if(reward){
          swal('You cann\'t change payment type if payout is already generated of this customer. Please! delete all generated payouts since deposit.');
...
/* Add More Bank Details Start */

    $(document).ready(function() {
        //associateauto();
        var max_fields      = 15; //maximum input boxes allowed
        var wrapper       = $(".ad-bank-del"); //Fields wrapper
        var add_button      = $(".add_more_bnkdel"); //Add button ID
        ...
        $(add_button).click(function(e){
            ...
            if(x < max_fields){ //max input box allowed
                x++; //text box increment
                $(wrapper).append('<div class="bnk-rows"><div class="col-md-12"><div class="row"><div class="form-group col-md-6"><label>Account Holder Name</label><input type="text" class="form-control" name="account_holder_names[]" id="account_holder_name" placeholder="Enter Account Holder Name" value="{{ old("account_holder_name") }}">@if($errors->has("account_holder_name"))
			<p>{{ $errors->first("account_holder_name") }}</p>@endif</div><div class="form-group col-md-6"><label>Bank Name</label><!-- <select name="bank_id" class="form-control"><option value="">Select</option>@foreach($banks as $bank)<option value="{{$bank->id}}">{{$bank->bank_name}}</option>@endforeach</select> --><input type="text" name="bank_names[]" class="form-control" placeholder="Enter Bank Name" value="{{old("bank_name")}}">@if($errors->has("bank_id"))<p>{{ $errors->first("bank_id") }}</p>@endif</div></div></div><div class="col-md-12"><div class="row"><div class="form-group col-md-6"><label>Account No</label><input type="text" class="form-control" name="account_numbers[]" id="account_number" placeholder="Enter Account Number" value="{{ old("account_number") }}">@if($errors->has("account_number"))<p>{{ $errors->first("account_number") }}</p>@endif</div><div class="form-group col-md-6"><label>IFSC Code</label><input type="text" class="form-control" name="ifsc_codes[]" id="ifsc_code" placeholder="Enter IFSC Code" value="{{ old("ifsc_code") }}">@if($errors->has("ifsc_code"))<p>{{ $errors->first("ifsc_code") }}</p>@endif</div><div class="form-group col-md-6"><label for="pan_no">Pan Number</label><input type="text" class="form-control" name="pan_nos[]" id="pan_no" placeholder="Enter Pan Number" value="{{old("pan_no")}}" >@if($errors->has("pan_no"))<p>{{ $errors->first("pan_no") }}</p>@endif</div><div class="col-md-2"><button class="btn text-danger remove_field" style="padding-top:37px;"><i class="material-icons">delete_outline</i></button></div></div></div>   </div>');
                //associateauto();
            }
            if(max_fields == x){
                $(".add_more_bnkdel").css('display','none');
            }
        });

        $(wrapper).on("click",".remove_field", function(e){
            if(x <= max_fields){
                $(".add_more_bnkdel").css('display','block');
            }
            //user click on remove text
            e.preventDefault(); $(this).parents('.bnk-rows').remove(); x--;
