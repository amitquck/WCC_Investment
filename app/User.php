...
class User extends Authenticatable
{
    ...
    public function lastMonthCustomerBalance()
    {
        return $this->customertransactions->where('cr_dr','cr')->whereBetween('deposit_date',[date('Y-m-01',strtotime("-1 month")),date('Y-m-t',strtotime("-1 month"))])->sum('amount');
    }
