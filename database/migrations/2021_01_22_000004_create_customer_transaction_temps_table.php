...
class CreateCustomerTransactionTempsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create(
            'customer_transaction_temps', function (Blueprint $table){
    ...
    {
        Schema::dropIfExists('customer_transaction_temps');
    }
}
