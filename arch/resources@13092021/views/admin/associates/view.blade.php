    ...
    <div class="row">  
      ...
      <div class="col-sm-4">
        ...
        <div class="input-group date" data-provide="datepicker">
          <input type="text" class="form-control"  id="nominee_dob" placeholder="Enter Date Of Birth" name="nominee_dob" value="<?php echo (isset($associate->associatedetail->nominee_dob) && $associate->associatedetail->nominee_dob != NUll)?date('d-m-Y',strtotime($associate->associatedetail->nominee_dob)):'' ?>" disabled="disabled">
