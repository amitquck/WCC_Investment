          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control datepicker" name="dob" id="dob" placeholder="Enter DOB" value="<?php echo (isset($associate->associatedetail->dob) && $associate->associatedetail->dob != NUll)?date('d-m-Y',strtotime($associate->associatedetail->dob)):'' ?>">
                @if($errors->has('dob'))
    ...
    <div class="row">  
      ...
      <div class="col-sm-4">
        ...
        <div class="input-group date" data-provide="datepicker">
          <input type="text" class="form-control datepicker"  id="nominee_dob" placeholder="Enter Date Of Birth" name="nominee_dob" value="<?php echo isset($associate->associatedetail->nominee_dob)?date('d-m-Y',strtotime($associate->associatedetail->nominee_dob)):'' ?>">
