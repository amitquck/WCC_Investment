           ...
           <div class="row">
              ...
              <div class="col-sm-4">
                 ...
                 <div class="input-group date" data-provide="datepicker">
                    <input type="text" class="form-control" placeholder="Enter Date Of Birth" name="dob" value="<?php echo (isset($customer->customerdetails->dob) && $customer->customerdetails->dob != NUll)?date('d-m-Y',strtotime($customer->customerdetails->dob)):'' ?>">
