    ...
    <div class="modal-content modal-md">
      ...
      <div class="modal-body">
        <table class="table table-bordered table-striped">
          <thead>
            <tr><td>Customer Wise Total Business</td></tr>
            <tr><td>Associate Wise Total Business</td></tr>
            <tr><td>State Wise Total Business</td></tr>
            <tr><td>City Wise Total Business</td></tr>
