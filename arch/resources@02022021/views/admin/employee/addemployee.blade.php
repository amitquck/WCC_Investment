...
<nav aria-label="breadcrumb" class="main-breadcrumb">
   <ol class="breadcrumb breadcrumb-style2">
      ...
      <li class="breadcrumb-item"><a href="javascript:void(0)">Employee's</a></li>
      ...
      <div class="col-md-12" style="padding-top:20px">
         <div class="row">
            <div class="form-group col-md-4">
               ...
               <input type="text" class="form-control" name="employee_id" id="employee_id" placeholder="Enter employee Id" value="{{old('employee_id')}}">
