...
<div class="sidebar-body">
  <ul class="nav nav-sub" id="menu">
   ...
   <!--  -->
    ...
    @if(Auth::user()->login_type == 'superadmin' || (Auth::user()->login_type == 'employee' && empCan('view_bulk_transaction')) )
      ...
      <li class="nav-item {{ (Request::route()->getName() == 'admin.deposit_in_bulkform') || (Request::route()->getName() == 'admin.edit_bulktxn') ? ' active' : '' }}">
        ...
        <ul>
          @if(Auth::user()->login_type == 'superadmin' || (Auth::user()->login_type == 'employee' && empCan('add_bulk_transaction_bulk_transaction')) )
          ...
          @endif
          @if(Auth::user()->login_type == 'superadmin' || (Auth::user()->login_type == 'employee' && empCan('edit_bulk_transaction_bulk_transaction')) ) 
