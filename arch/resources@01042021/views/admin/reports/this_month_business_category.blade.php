                ...
                <tr>
                  ...
                  <td>
                    @if($txn->customer_wise_this_month_business > 0)
                      <p class="text-success"> ₹ {{$txn->customer_wise_this_month_business}}</p>
                    @else
                      <p class="text-danger"> ₹ {{$txn->customer_wise_this_month_business}}</p>
                    @endif
                  </td>
                </tr>
              @endforeach
            ...
            @if($associates->count()>0)
              @foreach($associates as $key => $associate)
                  <tr>
                    ...
                    <td>
                      @if($associate->associate_wise_this_month_business > 0)
                        <p class="text-success"> ₹ {{$associate->associate_wise_this_month_business}}</p>
                      @else
                        <p class="text-danger"> ₹ {{$associate->associate_wise_this_month_business}}</p>
                      @endif
                    </td>
                  </tr>
              @endforeach
                  ...
                  <tr>
                    ...
                    <td>
                      @if($state->state_wise_this_month_business > 0)
                        <p class="text-success"> ₹ {{$state->state_wise_this_month_business}}</p>
                      @else
                        <p class="text-danger"> ₹ {{$state->state_wise_this_month_business}}</p>
                      @endif
                    </td>
                  </tr>
              @endforeach
