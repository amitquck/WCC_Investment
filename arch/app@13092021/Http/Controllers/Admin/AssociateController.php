...
class AssociateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $associate->associatedetail()->create([
            'image' => $name,
            'sex' => $request->sex,
            'dob' => date('Y-m-d',strtotime($request->dob))?date('Y-m-d',strtotime($request->dob)):'null',
            ...
            'nominee_dob' => date('Y-m-d',strtotime($request->nominee_dob))?date('Y-m-d',strtotime($request->nominee_dob)):'null',
