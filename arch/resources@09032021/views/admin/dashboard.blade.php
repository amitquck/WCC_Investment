...
<!------------>
  ...
  <div class="col mb-3" data-toggle="modal" data-target="#">
    <div class="card card-style-1" style="background-color: #3399ff;color:white;">
      <div class="card-body">
        ...
        <div class="d-flex align-items-center font-number mb-1">
        <a href="{{route('admin.debitor_creditor_list',['from_date'=>date('Y-m-01'),'to_date'=>date('Y-m-t')])}}" data-toggle="tooltip" title="View This Month Business"><h6 class="card-title text-light">This Month Business</h6></a>
          <span><i class="material-icons">₹</i></span>
        </div>
      ...
      <div class="modal-header">
        ...
        <table class="table table-bordered table-striped">
          <thead>
            ...
            <!-- <tr><td>2. <a href="">Associate Wise Total Business</a></td></tr> -->
            <tr><td>2. <a href="{{url('admin/this_month_business_category?q=state')}}">State Wise This Month Business</a></td></tr>
            <tr><td>3. <a href="{{url('admin/this_month_business_category?q=city')}}">City Wise This Month Business</a></td></tr>
          </thead>
        </table>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger btn-xs" data-dismiss="modal">Close</button>
  ...
  <div class="col mb-3" data-toggle="modal" data-target="#lastMonthBusiness">
    <div class="card card-style-1" style="background-color: #005580;color:white;">
      <div class="card-body">
        ...
        <div class="d-flex align-items-center font-number mb-1">
        <a href="{{route('admin.debitor_creditor_list',['from_date'=>date('Y-m-01',strtotime('-1 months')),'to_date'=>date('Y-m-t',strtotime('-1 months'))])}}" data-toggle="tooltip" title="View Last Month Business"><h6 class="card-title text-light">Last Month Business</h6></a>
      ...
      <div class="modal-header">
        ...
        <table class="table table-bordered table-striped">
          <thead>
            ...
            <tr><td>2. <a href="{{route('admin.last_month_business_category',['from_date'=>date('Y-m-01',strtotime('-1 months')),'to_date'=>date('Y-m-t',strtotime('-1 months')),'q'=>'state'])}}">State Wise Last Month Business</a></td></tr>

            <tr><td>3. <a href="{{url('admin/last_month_business_category?q=city')}}">City Wise Last Month Business</a></td></tr>
