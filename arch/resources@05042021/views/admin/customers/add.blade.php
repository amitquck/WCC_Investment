           ...
           <div class="form-group col-md-4">
            ...
            <div class="col-sm-4">
               ...
               <div class="input-group date">
                  <input type="text" class="form-control datepicker" placeholder="Enter Date Of Birth" name="dob" value="">
  ...
  <div class="col-md-12">
    <div class="row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control datepicker" name="cheque_issue_date[]" id="cheque_issue_date" placeholder="Enter Cheque Issue Date" value="{{ old('cheque_issue_date') }}" onclick="datepic();">
      ...
      <div class="form-group col-md-6">
        <label>Cheque Maturity Date</label>
         ...
         <input type="text" name="cheque_maturity_date[]" class="form-control datepicker" placeholder="Enter Cheque Maturity Date" value="{{old('cheque_maturity_date')}}">
  ...
  <div class="col-md-12">
    <div class="row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control datepicker" name="cheque_date[]" id="cheque_date" placeholder="Enter date" value="{{ old('cheque_date') }}">
        ...
        <div class="mania">&nbsp;
           <div class="row">
              <div class="col-md-6 form-group">
                 ...
                 <input type="text" onChange="calcomm(this.value)" id="customer" class="form-control customer" name="customer_invest" placeholder="Enter Customer Invest Percentage"   value="{{ old('customer_invest') }}" required="required">
