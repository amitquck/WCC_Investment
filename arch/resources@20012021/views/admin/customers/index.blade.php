        ...
        <tbody>
          ...
          @foreach($users as $key => $user)
            <tr>
              ...
              <td><a href="{{url('admin/customerHoldStatus/'.encrypt($user->id))}}"  class="btn btn-sm  btn-success @if($user->hold_status) @else btn-danger @endif" data-toggle="tooltip" title="@if($user->hold_status) Make Hold Payment @else Make Pay @endif">@if($user->hold_status)Pay @else Hold Payment @endif
              </a></td>
              <td class="text-center">
