          ...
          @if($banks->count()>0)
            @foreach($banks as $key =>$bank)
              <tr>
                ...
                <td>
                   @php $created_at = Carbon\Carbon::parse($bank->created_at)->format('j-M-Y'); @endphp
                  {{$created_at}}
                </td>
                <td>
      ...
      {{ csrf_field()}}
        ...
        <div class="modal-body" id="add-transaction-container">
          <div class="form-inline text-center">
            ...
            <div class="col-md-9">
              <input type="text" name="bank_name" class="form-control" style="width:100%;" required="required">
