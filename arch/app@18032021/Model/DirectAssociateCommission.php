...
class DirectAssociateCommission extends Model
{
    ...
    {
    	return $this->where('associate_id', $this->associate_id)->whereBetween('created_at',[date('Y-m-01 00:00:01',strtotime('-1 months')),date('Y-m-t 23:59:59',strtotime('-1 months'))])->sum('total_investment');
    }
}
