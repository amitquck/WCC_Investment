  ...
  @if($associate_txn)
    ...
    @if(empcan('export_associate_wise_customer') || Auth::user()->login_type == 'superadmin')
      <div class="col-md-3" style="margin-left:85%">
        <a href="{{route('admin.excel_associate_business',$params)}}" class="btn btn-danger btn-sm"><i class="material-icons">import_export</i> Excel Export</a>
      </div>
    @endif
  @endif
        ...
        <tbody>
          @if(Request::input('from_date') == null)
            ...
            @php $total_credit = $total_debit = 0; @endphp
              ...
              @php $total_credit += $investment->customer->customerMainBalance(); @endphp
                <tr>
