            ...
            <div class="col-md-12"><br>
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control datepicker" name="cheque_issue_date[{{$key}}]" id="cheque_issue_date" placeholder="Enter Cheque Issue Date" value="@if($s_cheque->cheque_issue_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_issue_date)) ?> @endif">
                </div>
                <div class="form-group col-md-6">
                  <label>Cheque Maturity Date</label>
                  <input type="text" name="cheque_maturity_date[{{$key}}]" class="form-control datepicker" placeholder="Enter Cheque Maturity Date" value="@if($s_cheque->cheque_maturity_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_maturity_date)) ?> @endif">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control datepicker" name="cheque_date[{{$key}}]" id="cheque_date" placeholder="Enter Cheque Date" value="@if($s_cheque->cheque_date != NULL) <?php echo  date('j-m-Y',strtotime($s_cheque->cheque_date)) ?> @endif">
