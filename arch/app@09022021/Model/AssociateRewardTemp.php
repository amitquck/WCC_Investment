...
class AssociateRewardTemp extends Model
{
    ...
    public function associatetransactions(){
        return $this->hasMany('App\Model\AssociateTransactionTemp','respective_table_id')->where('respective_table_name','associate_rewards');
    }
    ...
    //     // dump($this->month);
    //     // dump($this->year);
    //     // dump(AssociateReward::where('customer_id',$this->customer_id)->where('associate_id',$this->associate_id)->where('month',$this->month)->where('year',$this->year)->where('reward_type','commission')->toSql());
    //     return AssociateReward::where('customer_id',$this->customer_id)->where('associate_id',$this->associate_id)->where('month',$this->month)->where('year',$this->year)->where('reward_type','commission')->sum('amount');
    // }
