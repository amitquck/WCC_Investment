...
class AssociateController extends Controller
{
    ...
    public function direct_customer(Request $request)
    {
        ...
        if($request->associate_id){
            $assCust = AssociateCommissionPercentage::whereAssociateId(decrypt($request->associate_id))->whereStatus(1)->paginate(50);
            if($assCust){
                return view('admin.associates.direct_customer',compact('assCust'));
            }
