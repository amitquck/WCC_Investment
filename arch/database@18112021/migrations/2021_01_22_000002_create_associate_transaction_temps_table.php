...
class CreateAssociateTransactionTempsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create(
            'associate_transaction_temps', function (Blueprint $table){
    ...
    {
        Schema::dropIfExists('associate_transaction_temps');
    }
}
