          ...
          @if($banks->count()>0)
            @foreach($banks as $key =>$bank)
              <tr>
                ...
                <td>
                  @if($bank->amount+$bank->bank_current_balance > 0)
                    <p class="text-success">₹ {{$bank->amount+$bank->bank_current_balance}}</p>
                  @else
                    <p class="text-danger">₹ {{$bank->amount+$bank->bank_current_balance}}</p>
                  @endif
                </td>
