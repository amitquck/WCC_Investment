          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control datepicker" name="dob" id="dob" placeholder="Enter DOB" value="{{$associate->associatedetail->dob}}">
                @if($errors->has('dob'))
    ...
    <div class="row">  
      ...
      <div class="col-sm-4">
        ...
        <div class="input-group date" data-provide="datepicker">
          <input type="text" class="form-control datepicker"  id="nominee_dob" placeholder="Enter Date Of Birth" name="nominee_dob" value="{{$associate->associatedetail->nominee_dob}}">
  ...
  <div class="col-md-12">
    <div class="row">
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control n-get-csc" data-target-country="nominee_country" data-target-state="nominee_state" data-target-city="nominee_city" name="nominee_zipcode" id="zipcode" placeholder="Enter zipcode" value="{{$associate->associatedetail->nominee_zipcode}}">
