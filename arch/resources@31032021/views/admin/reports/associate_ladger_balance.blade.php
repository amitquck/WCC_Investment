              ...
              <tr>
                ...
                <td>
                  @if($associate->associatebalance() > 0)
                    <p><a href="{{route('admin.associate_ladger_customer',['associate_id'=>$associate->id])}}" class="text-success" data-toggle="tooltip" title="View Detail">₹ {{$associate->associatebalance()}}</a></p>
                  @else
