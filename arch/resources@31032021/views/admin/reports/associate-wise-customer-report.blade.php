          ...
          @if($associate_txn)
            @foreach($associate_txn as $key => $investment)
              <tr>
                ...
                <td class="text-info"><a href="{{route('admin.customer_detail',encrypt($investment->customer->id))}}" data-toggle="tooltip" title="View Details">{{$investment->customer->code}}</a></td>
