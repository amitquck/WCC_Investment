...
<!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css"> -->
  ...
  <nav aria-label="breadcrumb" class="main-breadcrumb">
    <ol class="breadcrumb breadcrumb-style2">
      ...
      <li class="breadcrumb-item active" aria-current="page">Customer Wise Monthly Report @if($user)<strong class="text-danger" data-toggle="tooltip" title="Customer Name (Code)" data-placement="bottom">#{{$user->name.'('.$user->code.')'}}</strong>@endif</li>
    </ol>
  </nav>
  <!-- /Breadcrumb -->
  @include('flash')	
    ...
    <div class="col-md-12">
      <form action="{{ route('admin.customerWiseMonthlyReport') }}" method="get">
        <div class="row">
          <div class="col-md-3">
            <input type="text" class="form-control" placeholder="Search" name="" id="cust_invest" autocomplete="off" data-toggle="tooltip" title="Search By Customer Name">
            <input type="hidden" name="id" id="hidden_cust_invest">
          </div>
          <div class="col-md-3">
