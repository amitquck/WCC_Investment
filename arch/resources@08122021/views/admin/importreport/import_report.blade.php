...
@include('flash')
<div class="col-md-3">
    <form action='{{ route("admin.userForImportExcel")}}' id="formId" method="get">
        <select name="user_type" id="userType" class="form-control" onchange="document.getElementById('formId').submit();">
    ...
    <div class="modal-content">
      ...
      {{ csrf_field()}}
        ...
        <div class="modal-body" id="delete_associate-container">
            <input type="hidden" name="user" value="@if(Request::has('user_type')) {{ Request::input('user_type') }} @endif">
          <div class="col-md-12">
...
//$('#userType').on('change',function(){
    //var user = $(this).val();
    //$.ajax({
        //url:'{{ route("admin.userForImportExcel")}}',
        //type:'get',
        //data:{user:user},
