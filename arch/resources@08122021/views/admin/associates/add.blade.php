          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password" value="{{old('password')}}" placeholder="Enter Password">
             ...
             <div class="form-group col-md-4">
                ...
                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" autocomplete="new-password" value="{{old('password_confirmation')}}" placeholder="Enter Confirm Password">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group col-md-4">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control datepicker" name="dob" id="dob" placeholder="Enter DOB" value="" autocomplete="off">
                @if($errors->has('dob'))
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        <div class="input-group date">
          <input type="text" class="form-control datepicker"  id="nominee_dob" placeholder="Enter Date Of Birth" name="nominee_dob" value="" autocomplete="off" onchange="nominee_ageCalculation(this.value)">
    ...
    <div class="row">
        ...
        @endif
         ...
         <div class="form-group col-md-4">
           ...
           <input type="text" class="form-control" name="nominee_age" id="nominee_age" placeholder="Enter age" value="{{ old('nominee_age') }}" autocomplete="off" >
       ...
       <div class="form-group col-md-4">
                <label for="image">Your Photo</label>
                <input type="file" name="nominee_image" id="image" placeholder="Enter Image" >
