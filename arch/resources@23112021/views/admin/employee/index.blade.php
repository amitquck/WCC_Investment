...
@section('content')
  ...
  <div class="col-md-1 pull-right">
    <a href="{{route('admin.all_employee_list_excel_export')}}" class="btn btn-success btn-md" data-toggle="tooltip" title="Excel Export"><i class="material-icons">import_export</i>
      </a>
  </div>
  <div class="d-flex">
            ...
            @if($employees->count()>0)
              ...
              <tr>
                ...
                <div class="btn-group btn-group-sm" role="group">
                  ...
                  <a href="{{route('admin.editemployee',encrypt($employee->id))}}" class="btn btn-default btn-link btn-icon bigger-130 text-info" data-toggle="tooltip" title="View Edit"  data-id="{{$employee->id}}"><i class="material-icons">edit</i></a>
