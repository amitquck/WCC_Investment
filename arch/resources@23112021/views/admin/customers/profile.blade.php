                    ...
                    <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr><th>Address</th><td>{{Auth::user()->customerdetails->address_one}}@isset(Auth::user()->customerdetails->address_two), @endisset {{Auth::user()->customerdetails->address_two}}@isset(Auth::user()->customerdetails->city_id), @endisset {{Auth::user()->customerdetails->citycity->name}}@isset(Auth::user()->customerdetails->state_id), @endisset {{Auth::user()->customerdetails->statestate->name}}@isset(Auth::user()->customerdetails->country_id), @endisset {{Auth::user()->customerdetails->countrycountry->name}}@isset(Auth::user()->customerdetails->zipcode), @endisset {{Auth::user()->customerdetails->zipcode}}</td></tr>
                                </table>
                            </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <tr><th>Account Holder Name</th><td>{{ ucwords(Auth::user()->customerdetails->account_holder_name)}}</td></tr>
                                    <tr><th>Bank Name</th><td>{{ ucwords(Auth::user()->customerdetails->bank_name)}}</td></tr>
                                    <tr><th>Account Number</th><td>{{ ucwords(Auth::user()->customerdetails->account_number)}}</td></tr>
                                    <tr><th>IFSC Code</th><td>{{ ucwords(Auth::user()->customerdetails->ifsc_code)}}</td></tr>
                                    <tr><th>Pan Number</th><td>{{Auth::user()->customerdetails->pan_no}}</td></tr>
                                </table>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr><th>Address Two</th><td>{{Auth::user()->customerdetails->nominee_address_two}},
