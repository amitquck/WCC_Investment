  ...
  <div class="col-md-12">
    <div class="row">
      ...
      <div class="col-md-2">
        ...
        <input type="text" class="form-control" placeholder="Associate Search" name="" id="cust_invest" autocomplete="off"  data-toggle="tooltip" title="Associate Search">
        <input type="hidden" name="associate" id="hidden_cust_invest">
      </div>
