      ...
      <div class="modal-content">
        ...
        <form method="post" action="{{route('admin.import_excel_transactions')}}" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <input type="hidden" name="year" class="form-control" value="{{Request::input('year')}}">
            <input type="hidden" name="payment_type" class="form-control" value="{{Request::input('payment_type')}}">
            <input type="hidden" name="user_type" class="form-control" value="{{Request::input('user_type')}}">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-6">
