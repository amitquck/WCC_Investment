            ...
            <div class="col-md-12">
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="date" class="form-control" name="cheque_issue_date[{{$key}}]" id="cheque_issue_date" placeholder="Enter Account Holder Name" value="@if($s_cheque){{ $s_cheque->cheque_issue_date }}@endif">
                </div>
                <div class="form-group col-md-6">
                  <label>Cheque Maturity Date</label>
                  <input type="date" name="cheque_maturity_date[{{$key}}]" class="form-control" placeholder="Enter Bank Name" value="@if($s_cheque){{$s_cheque->cheque_maturity_date}}@endif">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="cheque_number[{{$key}}]" id="cheque_number" placeholder="Enter date" value="@if($s_cheque){{ $s_cheque->cheque_number }}@endif">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="date" class="form-control" name="cheque_date[{{$key}}]" id="cheque_date" placeholder="Enter date" value="@if($s_cheque){{ $s_cheque->cheque_date }}@endif">
