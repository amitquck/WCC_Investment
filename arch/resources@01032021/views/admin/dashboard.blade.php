  ...
  <div class="col mb-3">
    <div class="card card-style-1" style="background-color: #005580;color:white;">
      <div class="card-body">
        ...
        <div class="d-flex align-items-center font-number mb-1">
        <a href="{{route('admin.debitor_creditor_list',['from_date'=>date('Y-m-01',strtotime('-1 months')),'to_date'=>date('Y-m-t',strtotime('-1 months'))])}}" data-toggle="tooltip" title="View This Month Business"><h6 class="card-title text-light">Last Month Business</h6></a>
