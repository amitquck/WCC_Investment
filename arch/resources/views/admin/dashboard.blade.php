...
<div class="row gutters-sm col-md-12">
  ...
  <div class="col mb-3">
    <div class="card card-style-1" style="background-color: #b3cccc;color:white;">
      <div class="card-body">
        <h2>{{$total_deposit}}</h2>
        <div class="d-flex align-items-center font-number mb-1">
        <h6 class="card-title">Customer Deposit</h6>
  ...
  <div class="col mb-3">
    <div class="card card-style-1" style="background-color: #005580;color:white;">
      <div class="card-body">
        <h2>{{$total_associate_commission}}</h2>
        <div class="d-flex align-items-center font-number mb-1">
...
<div class="row  col-md-12">
  <div class="col-md-6">
    <div class="card card-style-1">
      <div class="card-body">
        <h6 class="card-title">Latest Investment</h6><hr>
        <table class="table">
        	<thead>
        		<tr>
        			<th>Customer</th>
        	...
        	<tbody>
        		@foreach($latest_invest as $invest)
            <tr>
              ...
              <td>
                @php 
                  $deposit = Carbon\Carbon::parse($invest->deposit_date)->format('j-M-Y');
                 @endphp
                {{$deposit}}</td>
            </tr>
        		@endforeach
