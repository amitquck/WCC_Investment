          ...
          <div class="col-md-12">
            <div class="row">
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="email" id="email" placeholder="Enter Email" value="{{$associate->email}}" required="required">
                @if($errors->has('email'))
              ...
              <div class="form-group col-md-4">
                <label for="sex">Sex<span class="text-danger">*</span></label><br>
          ...
          <div class="col-md-12" style="padding-top:20px">
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" name="bank_name" class="form-control" value="{{$associate->associatedetail->bank_name}}">
