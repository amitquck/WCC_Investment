      ...
      {{ csrf_field() }}
         <div class="col-md-12 maini">
            ...
            <div class="form-group sub-btn">
               ...
               <i class="btn btn-primary col-md-1 float-right add-more" id="add-more" ><i class="material-icons">add</i></i>
            </div>
         </div>
      </form>
   </div>
