      ...
      <table class="table table-nostretch table-align-middle mb-0">
        ...
        @if($users)
          ...
          <tr>
            ...
            <td class=""> <strong>Bank Name - </strong> @if($user->bank_id === null) N/A @else <a>{{$user->bankname->bank_name}}</a> @endif  <br><strong>
            Cheque/DD Number - </strong>@if($user->cheque_dd_number === null) N/A @else <a>{{$user->cheque_dd_number}}</a> @endif <br> Cheque/DD date - @if($user->cheque_dd_date  === null) N/A @else {{date('d-m-Y',strtotime($user->cheque_dd_date))}} @endif </td>
