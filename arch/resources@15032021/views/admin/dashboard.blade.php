      ...
      <div class="modal-header">
        ...
        <table class="table table-bordered table-striped">
          <thead>
            ...
            <tr><td>2. <a href="{{route('admin.this_month_business_category',['from_date'=>date('Y-m-01 00:00:01'),'to_date'=>date('Y-m-t 23:59:59'),'q'=>'associate'])}}">Associate Wise This Month Business</a></td></tr>
      ...
      <div class="modal-header">
        ...
        <table class="table table-bordered table-striped">
          <thead>
            ...
            <tr><td>2. <a href="{{route('admin.last_month_business_category',['from_date'=>date('Y-m-01',strtotime('-1 months')),'to_date'=>date('Y-m-t',strtotime('-1 months')),'q'=>'associate'])}}">Associate Wise Total Business</a></td></tr>
      ...
      <div class="card-body">
        ...
        <table class="table">
            ...
            <tr>
              ...
              <td>₹ {{$topassociate->total_investment}}</td>
              <td>{{Carbon\Carbon::parse($topassociate->created_date)->format('j-m-Y')}}</td>
            </tr>
        		@endforeach
        	</tbody>
        </table>
