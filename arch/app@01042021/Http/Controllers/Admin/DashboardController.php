...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $top_associates = DirectAssociateCommission::select('associate_id','created_at',DB::raw('SUM(total_investment) as top_invest'))->groupBy('associate_id')->orderByDesc('top_invest')->limit(5)->get();
        // ->toSql();
        // dd($top_associates);
