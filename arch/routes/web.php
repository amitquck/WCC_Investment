...
Route::group(['prefix' => 'admin','as'=>'admin.','middleware' => 'auth'],function(){
	...
	Route::namespace('Admin')->group(function () {
		...
		Route::delete('associateDelete/{id}','AssociateController@destroy')->name('associateDelete');
		...
		Route::get('customerAllInvestInterestDelete/{id}','ReportController@destroyInterestAllInvest')->name('customerAllInvestInterestDelete');
