		...
		if($balance > 0){
			...
			foreach($customer_interest_percents as $key => $customer_interest_percent){
				...
				if($payable_days > 0){
					...
					$customerrewards->posting_date = $cumilatePdate?date('Y-m-01',strtotime($postingDate. ' + 1 month')):$postingDate;
					...
					$customerTransaction->posting_date = $cumilatePdate?date('Y-m-01',strtotime($postingDate. ' + 1 month')):$postingDate;
