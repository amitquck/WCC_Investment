...
<div class="col-md-12">
  <div class="row">
    <div class="form-group col-md-6">
      ...
      <input type="date" class="form-control" name="cheque_issue_date" id="cheque_issue_date" placeholder="Enter Account Holder Name" value="@if($security_cheque){{ $security_cheque->cheque_issue_date }}@endif">
    </div>
    <div class="form-group col-md-6">
      <label>Cheque Maturity Date</label>
      
       <input type="date" name="cheque_maturity_date" class="form-control" placeholder="Enter Bank Name" value="@if($security_cheque){{$security_cheque->cheque_maturity_date}}@endif">
...
<div class="col-md-12">
  <div class="row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="cheque_bank_name" id="cheque_bank_name" placeholder="Enter Bank Name" value="@if($security_cheque){{ $security_cheque->cheque_bank_name }}@endif">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="cheque_amount" id="cheque_amount" placeholder="Enter Amount" value="@if($security_cheque){{ $security_cheque->cheque_amount }}@endif">
    ...
    <div class="form-group col-md-6">
      <br>
      <img src="@if($security_cheque){{asset('images/chequeScanCopy/'.$security_cheque->scan_copy)}}@endif" width="50px;" height="50px;">
    </div>
  </div>
</div>
