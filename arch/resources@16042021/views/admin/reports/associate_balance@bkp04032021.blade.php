  ...
  <div class="col-md-12">
    <div class="row">
      ...
      <div class="col-md-2">
        ...
        <input type="hidden" name="associate_id" id="hidden_associate">
      </div>
            ...
            @foreach($customers as $key => $customer)
              <tr>
                ...
                @if($customer->login_type == 'customer')
                  ...
                  <td class="text-primary"><a href="{{route('admin.customer_associate_commission',encrypt($customer->id))}}"data-toggle="tooltip" title="View Detail">{{$customer->customeractiveinterestpercent->interest_percent}} %</a></td>
                  @if($month != '' && $year != '')
