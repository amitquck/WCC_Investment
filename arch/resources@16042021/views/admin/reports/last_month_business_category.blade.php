                ...
                <tr>
                  ...
                  <td>
                    @if($txn->customer_wise_last_month_business > 0)
                      <a href="{{route('admin.transactions',['customer'=>$txn->customers->code, 'from_date'=>Request::input('from_date'), 'to_date'=>Request::input('to_date')])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-success"> ₹ {{$txn->customer_wise_last_month_business}}</a>
                    @else
                      <a href="{{route('admin.transactions',['customer'=>$txn->customers->code, 'from_date'=>Request::input('from_date'), 'to_date'=>Request::input('to_date')])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-danger"> ₹ {{$txn->customer_wise_last_month_business}}</a>
                    @endif
                  </td>
                </tr>
              @endforeach
            ...
            @if($associates->count()>0)
              @foreach($associates as $key => $associate)
                  <tr>
                    ...
                    <td>
                      @if($associate->associateLastMonthBusiness() > 0)
                        <a href="{{route('admin.associate_business_report',['id'=>$associate->associate->id, 'from_date'=>Request::input('from_date'), 'to_date'=>Request::input('to_date')])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-success"> ₹ {{$associate->associateLastMonthBusiness()}}</a>
                      @else
                        <a href="{{route('admin.associate_business_report',['id'=>$associate->associate->id, 'from_date'=>Request::input('from_date'), 'to_date'=>Request::input('to_date')])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-danger"> ₹ {{$associate->associateLastMonthBusiness()}}</a>
                      @endif
                    </td>
                  </tr>
              @endforeach
                  ...
                  <tr>
                    ...
                    <td>
                      @if($state->state_wise_last_month_business > 0)
                        <a href="{{route('admin.state_business',['state_id'=>$state->id, 'from_date'=>Request::input('from_date'), 'to_date'=>Request::input('to_date')])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-success"> ₹ {{$state->state_wise_last_month_business}}</a>
                      @else
                        <a href="{{route('admin.state_business',['state_id'=>$state->id, 'from_date'=>Request::input('from_date'), 'to_date'=>Request::input('to_date')])}}" data-toggle="tooltip" title="View Ladger Balance" class="text-danger"> ₹ {{$state->state_wise_last_month_business}}</a>
                      @endif
                    </td>
                  </tr>
              @endforeach
