      ...
      <div class="card-body table-responsive">
        ...
        <table class="table">
            ...
            <tr>
              ...
              @if($topassociate->topAssociate($topassociate->associate_id) > 0)
                <td class="text-success">₹ {{$topassociate->topAssociate($topassociate->associate_id)}}</td>
              @else
                <td class="text-danger">₹ {{$topassociate->topAssociate($topassociate->associate_id)}}</td>
              @endif
              ...
              @foreach($top_invest as $invest)
                <tr>
                  ...
                  @if($invest->topInvesters() > 0)
                    <td class="text-success">₹ {{$invest->topInvesters()}}</td>
                  @else
                    <td class="text-danger">₹ {{$invest->topInvesters()}}</td>
                  @endif
                  <td>
