        ...
        <tbody>
          ...
          @foreach($users as $key => $user)
            <tr>
              ...
              <td>{{ucwords("$user->name")}}<br>
                <p class="text-info">{{$user->code}}</p>
              </td>
              <td>
              ...
              <td class="text-danger">₹ {{$user->customer_current_balance()}}
              </td>
              ...
              <td><a class="btn btn-xs  btn-success hold_remarks @if($user->hold_status)  @else btn-danger @endif" data-toggle="tooltip" data-id="{{$user->id}}" title="@if($user->hold_status) Make Hold Payment @else Make Pay @endif">@if($user->hold_status)Pay @else Hold Payment @endif
              </a></td>
              <td class="text-center">
                ...
                <a href="{{route('admin.customer_commission',encrypt($user->id))}}" class="btn btn-default btn-link btn-icon bigger-130 text-primary" data-toggle="tooltip" title="Add Investement"  data-id="{{$user->id}}"><i class="material-icons">add</i></a>
                 @endif
