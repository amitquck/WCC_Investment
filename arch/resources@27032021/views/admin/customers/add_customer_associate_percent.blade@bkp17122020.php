            ...
            <div class="mania">&nbsp;
               <div class="row">
                  <div class="col-md-6 form-group">
                     ...
                     <input type="text" onChange="calcomm(this.value)" id="customer" class="form-control customer" name="customer_invest" placeholder="Enter Customer Invest Percentage"   value="{{ $customer->customerinterestpercent->interest_percent }}">
