  ...
  <div class="col-md-12">
    <div class="row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" name="cheque_number[]" id="cheque_number" placeholder="Enter date" value="{{ old('cheque_number') }}">
