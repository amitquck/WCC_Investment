        ...
        <tbody>
            @if($users->count()>0)
              ...
              <tr>
                ...
                <td><a href="{{route('admin.associate_view',$user->id)}}" class="text-info" data-toggle="tooltip" title="View Details">{{$user->code}}</a></td>
                <td>{{$user->name}}</td>
                <td>
                ...
                <td class="text-danger"><a href="{{route('admin.associate_ladger_balance',['associate'=>$user->code])}}" class="text-danger" data-toggle="tooltip" title="View Ladger Balance">₹ {{$user->associatebalance()}}</a></td>
                <td> 
