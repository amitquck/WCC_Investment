...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard',compact('total_customer','total_deposit','total_interest','total_associate_commission','top_associates','current_invest','top_invest','data','customerdata','associatedata','total_associate_customer','this_month_txn','this_month_comm','this_month_inter','last_month_txn','last_month_comm','last_month_inter','total_associate','total_withdraw'));
    }
