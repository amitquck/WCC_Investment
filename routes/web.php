...
Route::group(['prefix' => 'associate','as'=>'associate.','middleware' => 'is_associate'],function(){
	Route::namespace('Admin')->group(function () {
		...
		Route::get('perAssoLadgerBalance','AssociateController@perAssoLadgerBalance')->name('perAssoLadgerBalance');
		Route::get('associate-transaction','AssociateController@associate_transaction')->name('associate_transaction');
		Route::get('associate_customer_transaction','AssociateController@custTxn')->name('custTxn');
		Route::get('heirarchy','AssociateController@heirarchy')->name('heirarchy');
		Route::get('direct_customer','AssociateController@direct_customer')->name('direct_customer');
		Route::get('export_associate_cust_txn','AssociateController@export_associate_cust_txn')->name('export_associate_cust_txn');
		Route::get('export_associate_direct_cust','AssociateController@export_associate_direct_cust')->name('export_associate_direct_cust');
		Route::get('export_associate_txn_hist','AssociateController@export_associate_txn_hist')->name('export_associate_txn_hist');
        Route::get('direct_customers','AssociateController@direct_customers')->name('direct_customers');
        Route::get('totCustBusiLastMon','AssociateController@totCustBusiLastMon')->name('totCustBusiLastMon');
        Route::get('selfCustBusiLastMon','AssociateController@selfCustBusiLastMon')->name('selfCustBusiLastMon');
        Route::get('totCustBusiThisMon','AssociateController@totCustBusiThisMon')->name('totCustBusiThisMon');
        Route::get('selfCustBusiThisMon','AssociateController@selfCustBusiThisMon')->name('selfCustBusiThisMon');
        Route::get('export_last_month_associate_business','AssociateController@export_last_month_associate_business')->name('export_last_month_associate_business');
        Route::get('export_this_month_associate_business','AssociateController@export_this_month_associate_business')->name('export_this_month_associate_business');
